          ...
          <div className="flex items-center gap-2 pr-6 border-r-[1px] border-bg_gray_light ">
            <div className="relative">
              <input
                ...
                className="w-full h-[40px]  text-white placeholder-secondary_light_400 
       rounded-md pl-10 pr-4 py-2 bg-bg_gray focus:outline-none focus:ring-2 focus:ring-primary_dark_700
