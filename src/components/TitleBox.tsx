      ...
      <div className="flex flex-row items-center justify-between gap-2 w-full h-[68px] px-[30px] border-b-[1px] border-bg_gray_light">
        ...
        transition duration-300 ease-in-out"
          ...
          <div className="flex flex-row items-center gap-3">
            ...
            <div className="border-[1px] border-bg_gray_light rounded-md h-[36px] text-center items-center flex justify-center px-2 gap-2 shadow-[inset_0_-7px_20px_2px_#F6F7FA22] hover:cursor-pointer hover:bg-primary_dark_700 transition duration-300 ease-in-out">
              <WalletIcon />
